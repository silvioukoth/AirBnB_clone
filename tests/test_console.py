...
Unittest classes:
    ...
    TestHBNBNCommand_exit
    TestHBNBNCommand_create
    TestHBNBNCommand_show
    TestHBNBNCommand_all
    TestHBNBNCommand_destroy
    TestHBNBNCommand_update
"""
import os
import sys
import unittest
